...
export const ancestryStats: { [k: string]: AncestryStatBlock } = {
  ...
  'Shadow Dog': {
    ...
    toughness: 0,
    morale: 1,
    traits: ['Undead', 'Horrify', 'Ravenous', 'Charge'],
  },
  'Shadows': {
    attack: 2,
    power: 1,
  ...
  'Celestial': {
    ...
    toughness: 2,
    morale: 1,
    traits: ['Charge', 'Horrify Necrotic',],
  },
  'Fungal': {
    attack: 2,
    power: 1,
...
export const sizeStats: { [k: string]: SizeStatBlock } = {
  d2: { costMultiplier: 0.22 },
  d3: { costMultiplier: 0.44 },
